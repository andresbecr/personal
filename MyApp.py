...
def mostrar_inicio():
    st.markdown(
        ...
        >Andrés Felipe Bedoya es un economista con experiencia en el área de la economía de la salud y en el uso de herramientas analíticas para analizar datos de salud. Actualmente está cursando una maestría en analítica aplicada de datos con énfasis en gerencia y análisis prescriptivo. 
        
        >Tiene una formación profesional en economía y finanzas internacionales. Ha trabajado como consultor e investigador en el área de la salud, donde ha participado en proyectos de consulta, limpieza y transformación de bases de datos, análisis descriptivos, diseño y aplicación de algoritmos de clasificación de riesgo en salud, diseño de modelos econométricos y evaluación de impacto en programas de salud. También ha desempeñado el cargo de auxiliar de investigación, donde ha apoyado en el desarrollo de modelos económicos y ha realizado análisis descriptivos y redacción de informes y presentaciones. 
